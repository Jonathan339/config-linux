...
#echo 'deb [signed-by=/usr/share/keyrings/tess.gpg] https://apt.tessapp.dev stable main' | sudo tee /etc/apt/sources.list.d/tess-packages.list
#sudo apt update && sudo apt install tess -y
clear
#vim plug
